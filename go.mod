...
require (
	...
	github.com/filecoin-project/lotus v1.22.0-rc6-boost
...
require (
	github.com/12shipsDevelopment/go-rediscounter v0.0.1 // indirect
...
replace github.com/filecoin-project/dagstore v0.7.0 => ../dagstore
